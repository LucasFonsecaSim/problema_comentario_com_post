...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		/* / Instanciando os comentários ' c1 e c2' e o post ' p1 './ */
		...
		/* / Adicionando os comentários no post, usando a função addComment. / */
		p1.addComment(c1);
		p1.addComment(c2);
		
		/* / Instanciando os comentários ' c3 e c4' e o post ' p2 './ */
		...
		/* / Print dos posts, com os comentários. / */
